...
data_base_connect_prod="host=10.10.130.152 dbname=aroundtest user=vodaplications password=V0D-20234pl1c4t10ns" #Datos para establecer conexion con la base de datos de produccion.
aws_profile='pythonapps' #Nombre del perfil de aconexion a AWS
Mail_To=['mgarcia@vcmedios.com.co']#['ingenieriavcmc@vcmedios.com.co', 'ingenieriavod@vcmedios.com.co'] #E-mail de destino 
